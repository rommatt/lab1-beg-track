...
var lion = 'lion';
var tiger = 'tiger';
assert(lion === lion, 'lion is equal to lion - this assert should pass.');
assert(tiger === lion, 'tiger is not equal to lion - this assert should not pass.');
